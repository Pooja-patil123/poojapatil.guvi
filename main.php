...
<body>
    <div class="header">
        ...
        <div class="header-right"> -->
            ...
            <div class="header-left">
              <a href="#"><b>Home</b></a>
              <a href="pricingPage.php"><b>Pricing</b></a>
              <a href="servicesPage.php"><b>services</b></a>
              </div>
            ...
            <div class="header-right">
                <div id="mySidebar" class="sidebar">
                    ...
                    <a href="mainLogin.php">User Login <br><br></a>
                    <a href="mainloginDe.php">delivery Login <br><br></a>
                    <a href="mainloginSP.php">shop Login <br><br></a>
                    <a href="mainloginAD.php">Admin Login <br><br></a>
                </div>
    ...
    <div class="slider">
        ...
        <div class="myslider fade" style="display: block;">
            ...
            <button class="btnn" onclick="window.location.href = 'mainlogin.php';">order</button>
    ...
    <section class="services">
        ...
        <div class="s-box-container">
            <div class="s-box">
                ...
                <h1>washing</h1>
                <a href="servicesPage.php" class="s-btn">More</a>
            </div>
            <div class="s-box">
                <div class="bar"></div>
    ...
    <div class="pricing-table">
        <div class="pricing-card">
            <h3 class="pricing-card-header">Standard Package</h3>
            <div class="price">50 clothes per month
            </div>
            <ul>
                <li><strong>4 </strong> T-shirt</li>
                <li><strong>1 </strong>Pair of jeans</li>
                <li><strong>3 </strong>button-downshirts </li>
                <li><strong>5 </strong>pair of shorts</li>
                <li><strong>1 </strong>towel</li>
                <li><strong>6 </strong>Pair of Socks</li><br>
                <h1>Rs. 499 </h1>
            </ul>
            <a href="mainLogin.php" class="order-btn">Order Now</a>
        </div>

        <div class="pricing-card">
            <h3 class="pricing-card-header">Enterprise Package</h3>
            <div class="price">60 Clothes per Month
            </div>
            <ul>
                <li><strong>6 </strong> T-shirts</li>
                <li><strong>3 </strong> Pair of Jeans</li>
                <li><strong>4 </strong> Button-downshirt</li>
                <li><strong>8 </strong> Pair of shorts</li>
                <li><strong>5 </strong> Pairs underwears</li>
                <li><strong>2</strong>pair of towels</li><br>
                <h1>Rs. 599 </h1>
            </ul>
            <a href="mainLogin.php" class="order-btn">Order Now</a>
        </div>
        ...
        <div class="pricing-card">
            <h3 class="pricing-card-header">Premium Package</h3>
            <div class="price">80 Clothes Per Month</div>
            <ul>
                <li><strong>4 </strong>T-shirts</li>
                <li><strong>2 </strong>Pair of Jeans</li>
                <li><strong>2 </strong>Button-downshirt </li>
                <li><strong>3 </strong>Pair of shorts</li>
                <li><strong>2 </strong>Towel</li>
                <li><strong>2 </strong>Pairs underwears</li><br>
                <h1>Rs. 699 </h1>
            </ul>
            <a href="mainLogin.php" class="order-btn">Order Now</a>
        </div>
    ...
    <div class="works">
        <div class="row">
            <div class="column">
                <div class="content">
                    <span class="img-container">
                        <img src="dirty clothes.jpg" alt="delivery" style="width:50%">
                    </span>
                    <h3 style="text-align:center">Curb-side pickup</h3>
            ...
            <div class="column">
                <div class="content">
                    <span class="img-container">
                        <img src="truck_page.jpg" alt="cart" style="width:57%">
                    </span>

                    <h3 style="text-align:center">Free shipping on orders over $50</h3>
            ...
            <div class="column">
                <div class="content">
                    <span class="img-container">
                        <img src="washing_steps.jpg" alt="24/7" style="width:59%">
                    </span>

                    <h3 style="text-align:center">Low prices guaranteed </h3>
            ...
            <div class="column">
                <div class="content">
                    <span class="img-container">
                        <img src="folded_.jpg" alt="lowprice" style="width:50%">
                    </span>
                    <h3 style="text-align:center">Available to you 24/7</h3>
